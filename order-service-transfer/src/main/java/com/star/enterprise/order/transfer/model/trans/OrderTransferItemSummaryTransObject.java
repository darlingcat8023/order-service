...
public class OrderTransferItemSummaryTransObject {
    ...
    private OrderTransferItemFeeSummaryTransObject itemFee;

    public OrderTransferItemSummaryTransObject(OrderTransferItemInfoEntity entity, OrderTransferItemFeeSummaryTransObject itemFee) {
