...
import static com.star.enterprise.order.refund.data.jpa.entity.OrderRefundInfoEntity.TABLE_NAME;
...
@Table(name = TABLE_NAME, indexes = {
        @Index(name = "idx_orie_rid_sta", columnList = "refundOrderId, refundStatus"),
        @Index(name = "idx_orie_tid", columnList = "targetId"),
        @Index(name = "idx_orie_aid", columnList = "approvalId")
})
@EntityListeners(value = {AuditingEntityListener.class})
public class OrderRefundInfoEntity {

    protected static final String TABLE_NAME = "order_refund_info";
     ...
     */
    @DomainEvents
    public List<OrderRefundInfoAsyncEvent> domainEvents() {
        return List.of(new OrderRefundInfoAsyncEvent(this.refundOrderId, OrderRefundStatusEnum.of(this.refundStatus), this.version, this.target, this.delayTasks));
    }
