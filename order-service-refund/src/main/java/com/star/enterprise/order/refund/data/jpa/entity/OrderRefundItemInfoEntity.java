...
import static com.star.enterprise.order.refund.data.jpa.entity.OrderRefundItemInfoEntity.TABLE_NAME;
...
@Table(name = TABLE_NAME, indexes = {
        @Index(name = "idx_oriie_rid_roid", columnList = "refundOrderId, refundOrderItemId"),
        @Index(name = "idx_oriie_oid_oiid", columnList = "orderId, orderItemId")
})
@EntityListeners(value = {AuditingEntityListener.class})
public class OrderRefundItemInfoEntity {

    protected static final String TABLE_NAME = "order_refund_item_info";
    ...
    public void prePersist() {
        this.refundOrderItemId = UUID.randomUUID().toString();
    }
