...
import static com.star.enterprise.order.receipt.data.jpa.entity.ReceiptTransferOrderEntity.TABLE_NAME;
...
@Table(name = TABLE_NAME, indexes = {
        @Index(name = "idx_rtoe_roid", columnList = "transferOrderId"),
        @Index(name = "idx_rtoe_reno", columnList = "receiptNo")
})
public class ReceiptTransferOrderEntity implements Receipt {

    protected static final String TABLE_NAME = "receipt_transfer_order";
    ...
    public ReceiptTypeEnum type() {
        return ReceiptTypeEnum.TRANSFER_ORDER;
    }
